#!/bin/bash
#
# USAGE: multiply-statistics.sh <volume>-<part>-<isotope>-<type> <factor> <nfiles>

if [ -f ./multiply-statistics.sh ]; then
  ...
  echo ERROR: must cd in UTILS/create-macros before calling "./multiply-statistics.sh"!
fi
